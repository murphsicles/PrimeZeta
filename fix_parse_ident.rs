...
// The issue is that "while" is not in the keyword list in parse_ident
// Also "and", "or", "not" are commented out but should be included

// Current parse_ident keyword list:
/*
[
