...
fn main() {
    ...
    // Type checker starts
    manager.update_status("type_checker", ComponentStatus::Processing, "Type checking AST");
    println!("   - Type Checker: Type checking AST...");
    
    // Type checker completes
    manager.update_status("type_checker", ComponentStatus::Complete, "Type checking complete");
    ...
    // Codegen completes
    manager.update_status("codegen", ComponentStatus::Complete, "Code generation complete");
    println!("   - Code Generator: Code generation complete");
    
    // Integration reports success
    manager.update_status("integration", ComponentStatus::Complete, "Compilation successful");
