...
fn main() {
    ...
    let test_cases = vec![
        ("Simple #[test] attribute", r#"
        #[test]
        fn test_simple() -> i64 {
            42
        }
        "#),
        ("#[derive(Clone)] attribute", r#"
        #[derive(Clone)]
        struct Point {
            x: i64,
            y: i64,
        ...
        "#),
        ("Attribute with multiple arguments", r#"
    ...
    println!("\n=== Summary ===");
    println!("Passed: {}/{} ({:.1}%)", passed, total, (passed as f32 / total as f32) * 100.0);
