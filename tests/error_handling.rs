...
fn test_diagnostic_formatting() {
    ...
    println!("Contains error[E1002]: {}", formatted.contains("error[E1002]"));
    println!("Contains test.z:3:10-15: {}", formatted.contains("test.z:3:10-15"));
    println!("Contains help:: {}", formatted.contains("help:"));
    println!("Contains unterminated string literal: {}", formatted.contains("unterminated string literal"));
...
fn test_multiple_errors() {
    ...
    reporter.report(
        Diagnostic::error("E3001", "undefined variable `z`".to_string())
            .with_span(span2)
    );
